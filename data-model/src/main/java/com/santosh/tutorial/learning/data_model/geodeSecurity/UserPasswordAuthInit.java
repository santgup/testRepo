...
package com.santosh.tutorial.learning.data_model.geodeSecurity;
...
/**
 * A sample {@link AuthInitialize} implementation that obtains the user name and
 ...
 * set to the fully qualified name the static <code>create</code> method
 * 
 * @author Sumedh Wale
 * @since 5.5
 */
